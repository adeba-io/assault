...
namespace Assault.Editors
{
    ...
    public class AttackDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(rect_knockbackType, property.FindPropertyRelative("knockbackType"), GUIContent.none);
            ...
            if (property.FindPropertyRelative("knockbackType").enumValueIndex == 0)
            {
            ...
            if (_jointChange)
            {
                ...
                property.FindPropertyRelative("jointID").intValue = s_joints[_ownerID].ID;
        ...
        Joint GetJointByID(int jointID)
        {
            for (int i = 0; i < _joints.Length; i++)
            {
        ...
        void SetRects(Rect position, bool label)
        {
            ...
            rect_knockbackType = new Rect(rect_knockbackLabel.xMax, rect_knockbackLabel.y, position.width * 0.6f, EditorGUIUtility.singleLineHeight);
